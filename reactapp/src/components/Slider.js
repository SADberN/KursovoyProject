(function () {
  ...
  function CustomEvent(event, params) {
    ...
    const e = new CustomEvent(event, params.bubbles, params.cancelable, params.detail);
    return e;
  }
...
export function SimpleAdaptiveSlider(selector, config) {
  // .slider
...
SimpleAdaptiveSlider.prototype._move = function () {
  ...
  var step = this._direction === 'next' ? -80 : 80;
